...
func _throw():
	...
	throwableInstance._initialize_arrow(throwable, Vector2(200,0).rotated(get_angle_to(get_global_mouse_position())), get_angle_to(get_global_mouse_position()), self, inBulletTime)
	throwable = "Battery"
